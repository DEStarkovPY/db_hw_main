import sqlalchemy
DSN = 'postgresql://postgres:Zxc25532335dd.@localhost:5432/netology_db'
#Data sourse name(т.е. путь до данных)
engine = sqlalchemy.create_engine(DSN) #функция подключения к базе данных
